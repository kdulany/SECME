...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/Written Report Judge MTC_WBR.docx")
```
<center>
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/Mouse Trap Car Judging_InPerson.docx")
```
<center>
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/Mouse Trap Car Judging_Virtual.docx")
```
<center>
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/Engineering Notebook Judge.docx")
```
<center>
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/WBR Judging_InPerson.docx")
```
<center>
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/WBR Judging_Virtual.docx")
```
<center>
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/Patch Design Challenge_Judge Eval.docx")
```
<center>
...
```{r echo=FALSE}
xfun::embed_file("/Users/kristadulany/Documents/GitHub/SECME/SECME Guidlines_22-23/docs/The Art of Engineering Judge Eval.docx")
```
<center>
